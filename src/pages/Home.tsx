  ...
  return (
    <AppShell hideNav={!user}>
      <div className="px-5 md:px-0 pt-12 md:pt-16 pb-6 animate-fade-in">
        ...
        <h1 className="text-display md:text-5xl lg:text-6xl md:font-semibold md:tracking-tight mb-4 md:mb-6">
          Audit visual UX,<br />
          <span className="text-muted-foreground">in seconds.</span>
        </h1>
        <p className="text-base md:text-lg text-foreground/75 leading-relaxed mb-8 md:mb-10 max-w-sm md:max-w-xl">
        ...
        {!user && (
          <p className="mt-6 md:mt-8 text-xs md:text-sm text-center md:text-left text-muted-foreground">
